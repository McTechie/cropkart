...
import { MenuRow, BasketPopup } from '../components';
      ...
      <ScrollView>
        <View className='relative'>
          ...
          <TouchableOpacity
            ...
            <ArrowLeftIcon size={20} color='#f43f5e' />
          </TouchableOpacity>
        </View>
        ...
        <View className='bg-white'>
          ...
          <TouchableOpacity className='flex-row items-center space-x-2 p-4 border-y border-gray-300'>
            ...
            <Text className='pl-2 flex-1 text-base font-bold'>Have a food allergy?</Text>
            <ChevronRightIcon color='#f43f5e' />
          </TouchableOpacity>
        </View>
