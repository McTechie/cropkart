...
class TFModel:
    ...
    def load(self) -> None:
        ...
        tf.saved_model.load(self.model_dir,tags=self.signature.get("tags"), export_dir=self.model_dir)
...
if __name__ == "__main__":
    ...
    parser.add_argument("image", help="pic.png")
    args = parser.parse_args()
    # Assume model is in the parent directory for this file
    pic_dir = os.getcwd()+'/app/model/'
    print(pic_dir)
    if os.path.isfile(pic_dir+args.image):
        image = Image.open(pic_dir+args.image)
        model_dir = os.getcwd()+'/app/model/'
